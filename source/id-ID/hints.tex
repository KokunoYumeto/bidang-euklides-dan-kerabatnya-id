...
\parbf{\ref{ex:SMS}.} 
Let $D$ and $D'$ be reflections of $C$ and $C'$ across $M$ and $M'$ respectively.
Show that $\triangle BCD\z\cong \triangle B'C'D'$, and use this to prove that $\triangle A' B' C'\z\cong\triangle A B C$.
...
\parbf{\ref{ex:motion}.}
Construct three circles with centers at $A'$, $B'$, and $C'$ and radiuses $AX$, $BX$, and $CX$, respectively.
