...
\textit{Assume $f\:\mathbb{R}\to \mathbb{R}$ is a motion of the line that sends $0\mapsto 0$ and one positive number to a positive number.
Then $f$ is an identity map.}
...
It remains to apply \ref{ex:[OA)=[OB)} and \ref{thm:straight-angle} respectively in these two cases.
...
Apply \ref{cor:half-plane}\textit{\ref{cor:half-plane:intersect}} to show that $O$ and $A'$
lie on the same side of~$(AB)$.
Similarly, $O$ and $B'$ lie on the same side of~$(AB)$.
Apply \ref{cor:half-plane}\textit{\ref{cor:half-plane:intersect}} again.
