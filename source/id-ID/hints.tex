...
Conclude that the values $\measuredangle AOX$ and $\measuredangle XOB$ are either both nonnegative or both nonpositive.

In each case, argue as in \ref{ex:a+b==c} to show that
\columnbreak
$|\measuredangle AOX|\z+|\measuredangle XOB|=\pi$ and draw a conclusion.
...
Apply \ref{ex:pbisec-side}, \ref{ex:between}, and \ref{thm:isos}.
...
Therefore, $\hat A$ is fixed by this reflection.
...
Apply the three-nail lemma (Exercise~\ref{ex:ABC-motion}) to show that the composition of the constructed reflections coincides with the given motion.
...
Applying \textit{(a)}, show that the angle at $A$ is acute.
Repeat it for~$B$.
